        ...
        <div className="container p-5">
          <div className="row">
            <div className="col-md-6 pr-md-3">
              <h2 className='text-center'>Coworking Software to streamline operations & enhance retention</h2>
              <p>  Manage resources and operations of your coworking space
                seamlessly. Inspire confidence to get back to the office –
                designed for coworking spaces of all sizes</p>
            </div>
            <div className="col-md-6 pl-md-3 d-flex justify-content-center align-items-center">
