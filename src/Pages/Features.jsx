    ...
    <div className="row gy-5">
      <div className="col-12 col-sm-6 col-lg-4">
        <div className="text-center px-xl-2">
          <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} fill="currentColor" className="bi bi-1-circle-fill mb-4" style={{color:"#11235A"}} viewBox="0 0 16 16">
      ...
      <div className="col-12 col-sm-6 col-lg-4">
        <div className="text-center px-xl-2">
          <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} fill="currentColor" className="bi bi-2-circle-fill  mb-4" style={{color:"#11235A"}} viewBox="0 0 16 16">
      ...
      <div className="col-12 col-sm-6 col-lg-4">
        <div className="text-center px-xl-2">
          <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} fill="currentColor" className="bi bi-3-circle-fill  mb-4" style={{color:"#11235A"}}viewBox="0 0 16 16">
      ...
      <div className="col-12 col-sm-6 col-lg-4">
        <div className="text-center px-xl-2">
          <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} fill="currentColor" className="bi bi-4-circle-fill  mb-4" style={{color:"#11235A"}} viewBox="0 0 16 16">
      ...
      <div className="col-12 col-sm-6 col-lg-4">
        <div className="text-center px-xl-2">
          <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} fill="currentColor" className="bi bi-5-circle-fill mb-4" style={{color:"#11235A"}} viewBox="0 0 16 16">
      ...
      <div className="col-12 col-sm-6 col-lg-4">
        <div className="text-center px-xl-2">
          <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} fill="currentColor" className="bi bi-6-circle-fill  mb-4" style={{color:"#11235A"}} viewBox="0 0 16 16">
